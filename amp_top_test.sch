...
C {vsource.sym} -140 -20 0 0 {name=V2 value=vin savecurrent=false}
...
C {code_shown.sym} 260 -150 0 0 {name=dc only_toplevel=false 
value=
"
.include /foss/pdks/gf180mcuD/libs.tech/ngspice/design.ngspice
.lib /foss/pdks/gf180mcuD/libs.tech/ngspice/sm141064.ngspice  typical
.lib /foss/pdks/gf180mcuD/libs.tech/ngspice/sm141064.ngspice  res_typical
.lib /foss/pdks/gf180mcuD/libs.tech/ngspice/sm141064_mim.ngspice  mimcap_typical

.control
  ac dec 50 10 100MEG
  plot vdb(out)
  meas ac kv_v_per_v max mag(v(out))
  meas ac kv_db max vdb(out)
  let target = kv_db - 3
  meas ac fd find frequency when vdb(out)=target rise=1
  meas ac fg find frequency when vdb(out)=target fall=1
